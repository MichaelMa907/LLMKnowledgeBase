...
last_active: "2026-05-03 11:32"
last_session: "2026-05-03 11:32"
resolved: false
status: "active"
sessions_count: 7
commit_threads_count: 7
total_prompt_entries: 38
...
- Decide later whether the included system reference project should be trimmed or split if it becomes too large for a starter release.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-05-03 11:23 | 2026-05-03 11:32 | Codex | `codex-20260503-1123` | `Projects/llm-knowledge-base-system/Commits/2026-05-03 1123 - graph-wikilink-audit-cleanup.md` | 2 | open | Tightened the Obsidian graph wikilink policy, cleaned existing bad graph links, added an audit script, regenerated indexes from source, and added external project agent-corner artifact folders |
...
- [11:32] Added the external project artifact-placement rule: Codex-created support files kept with real external projects go under `Codex's Corner/`, Claude-created support files go under `Claude's Corner/`, and normal source/config/project files still go where the project requires.
...
- [01:45] Refined the release boundary after user clarification so `Projects/llm-knowledge-base-system/` and its learned notes are tracked as the built-in reference/sample project, while the other local projects and machine/user data remain excluded.
- [01:54] Added README setup instructions plus PowerShell and batch wrappers for the full updater rebuild, clarifying that users must point each agent's global instruction file at the cloned vault and generate local indexes such as `Globals/globalIndex.md`.
